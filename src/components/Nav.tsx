...
export function Nav() {
  return (
    <header className="sticky top-0 z-50 border-b border-line/65 bg-ink/92 shadow-[0_8px_30px_rgba(4,19,38,0.16)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-5 px-5 py-3.5 sm:px-8 lg:px-10">
        ...
        <div className="hidden items-center gap-4 sm:flex">
          <Link href="/login" className="min-h-11 px-2 py-3 text-[15px] text-parchment-dim transition hover:text-parchment">
            Log in
          </Link>
          <Link
            href="/book"
        ...
        <details className="group relative sm:hidden">
          <summary className="flex h-11 w-11 cursor-pointer list-none items-center justify-center rounded-xl border border-line bg-surface-raised text-parchment marker:content-none">
