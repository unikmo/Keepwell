...
export default function TermsPage() {
  return (
    <LegalDoc title="Terms of Service" lastUpdated="August 15, 2026">
      ...
      <LegalSection title="8. Digital Access"><p>Digital Access allows users to store access instructions and, where enabled, sensitive access details. Sensitive text entered through the Keepwell application is encrypted by the application server before ciphertext is persisted to the database. Reference photos are stored in a private storage bucket and delivered through time-limited signed access. Trusted contacts and key-holder records do not automatically receive access to Digital Access secrets. Users remain responsible for controlling their account credentials and deciding what information to store.</p></LegalSection>
