...
export default async function PropertyManagerWorkspace({ searchParams }: { searchParams: Promise<{ notice?: string; error?: string }> }) {
  ...
  return <div className="flex min-h-screen flex-col"><Nav /><main className="flex-1 py-12"><div className="mx-auto max-w-6xl px-6">
    <div className="eyebrow">Property-manager operations</div><h1 className="mt-2 font-display text-4xl text-parchment">One access workflow across the portfolio</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-parchment-dim">Submit resident lockouts, turnover rekeys and access work to Keepwell. Independent providers perform the field service; Keepwell keeps the request, pricing and service record in the platform.</p>
