  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto grid max-w-[1400px] gap-10 px-6 py-14 sm:px-8 sm:py-18 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:gap-16 lg:px-10 lg:py-20">
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/digital-sentinel" className="inline-flex min-h-12 items-center justify-center rounded-full bg-brass px-7 py-3 text-[15px] font-semibold text-ink transition hover:brightness-110">
                  Set up Digital Sentinel
                </Link>
                <Link href="/book" className="inline-flex min-h-12 items-center justify-center rounded-full border border-line px-7 py-3 text-[15px] font-semibold text-parchment transition hover:border-brass/45">
                  Request service
                </Link>
              </div>
              <p className="mt-5 text-sm leading-6 text-parchment-dim/80">
                Keepwell operates the platform. Field work is performed by independent local providers.
              </p>
            </div>

            <div className="relative overflow-hidden rounded-[34px] border border-line bg-surface shadow-2xl">
              <img src={HERO_IMAGE} alt="Modern residential front entrance" className="h-[430px] w-full object-cover sm:h-[520px]" loading="eager" />
              <div className="absolute inset-x-5 bottom-5 rounded-2xl border border-white/10 bg-ink/88 p-5 backdrop-blur-md sm:inset-x-6 sm:bottom-6">
        ...
        <section className="border-b border-line/70 bg-surface/18">
        ...
        <section className="border-b border-line/70 py-16 sm:py-20">
          <div className="mx-auto grid max-w-[1400px] gap-10 px-6 sm:px-8 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:gap-16 lg:px-10">
            ...
            <div className="max-w-xl">
              ...
              <h2 className="mt-4 font-display text-4xl font-medium leading-[1.04] tracking-[-.025em] text-parchment sm:text-5xl">
                Solve the lockout before it becomes a service call.
              </h2>
              <p className="mt-5 text-lg leading-8 text-parchment-dim">
              ...
              <Link href="/digital-sentinel" className="mt-7 inline-flex min-h-11 items-center justify-center rounded-full bg-brass px-6 py-2.5 text-sm font-semibold text-ink">
        ...
        <section className="border-b border-line/70 bg-surface/18 py-16 sm:py-20">
          <div className="mx-auto max-w-[1400px] px-6 sm:px-8 lg:px-10">
            ...
            <div className="mt-8 grid gap-4 lg:grid-cols-3">
              {quickServices.map((service) => (
                <div key={service.id} className="rounded-[24px] border border-line bg-ink/35 p-6">
          ...
          <div className="mx-auto max-w-[1400px] px-6 sm:px-8 lg:px-10">
            <div className="grid gap-10 lg:grid-cols-[.72fr_1.28fr] lg:items-start">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {plans.map((plan) => (
                  <div key={plan.id} className={`rounded-[22px] border p-5 ${plan.id === "household_plus" ? "border-brass/45 bg-brass/[.07]" : "border-line bg-surface/55"}`}>
        ...
        <section className="border-b border-line/70 bg-surface/18 py-10">
          <div className="mx-auto grid max-w-[1400px] gap-4 px-6 sm:px-8 md:grid-cols-2 lg:px-10">
            <Link href="/for-property-managers" className="group rounded-2xl border border-line bg-ink/30 p-5 transition hover:border-brass/45">
            ...
            <Link href="/for-real-estate-agents" className="group rounded-2xl border border-line bg-ink/30 p-5 transition hover:border-brass/45">
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto max-w-3xl px-6 text-center sm:px-8">
            ...
            <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
              <Link href="/digital-sentinel" className="inline-flex min-h-12 items-center justify-center rounded-full bg-brass px-7 py-3 text-sm font-semibold text-ink">Set up Digital Sentinel</Link>
              <Link href="/book" className="inline-flex min-h-12 items-center justify-center rounded-full border border-line px-7 py-3 text-sm font-semibold text-parchment">Request service</Link>
            </div>
          </div>
        </section>
      </main>
